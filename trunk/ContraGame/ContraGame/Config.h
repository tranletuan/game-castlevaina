...
#define ENEMY_RUN_MAN_VX 0.085f
#define ENEMY_RUN_MAN_VY 5.0f
#define ENEMY_RUN_MAN_BOUNDS_WIDTH 16
#define ENEMY_RUN_MAN_BOUNDS_HEIGHT 26
#define ENEMY_RUN_MAN_TOTAL 5
#define ENEMY_RUN_MAN_DISTANCE_ACTIVE 50
#define ENEMY_RUN_MAN_ELAPSED_TIME_ATTACK 400
