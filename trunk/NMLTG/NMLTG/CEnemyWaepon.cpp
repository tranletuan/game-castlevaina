...
void CEnemyWaepon::LoadResources()
{
	int id = 1;
...
void CEnemyWaepon::RemoveDisabledBullet()
{
...
CollisionDirection CEnemyWaepon::CheckCollision(CObject* obj)
{
	return TopCollision;
}
